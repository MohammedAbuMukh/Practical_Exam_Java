					...
					<div class="card-body">
						...
						<div class="form-section">
							...
							<form:form action="/register" method="post"
								modelAttribute="newPeople">
								<div class="mb-3">
									<form:label path="peopleName" cssClass="form-label"
										for="peopleName">User Name:</form:label>
									<form:input path="peopleName" id="peopleName"
										class="form-control" placeholder="Enter your Peoplename" />
								...
								<div class="mb-3">
									...
									<form:input path="email" id="registerEmail"
						...
						<div class="form-section mt-4">
							<form:form action="/login" method="post"
								...
								<div class="mb-3">
									<form:label path="password" cssClass="form-label"
										for="loginPassword">Password:</form:label>
